...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if(mouseColor == -772907 ) {
				
		JOptionPane.showMessageDialog(null, "You Won! Let's get ICE CREAM..."); 
		}
	}

	private void scare() {
		System.out.println("BOO!@pinaple.com have a good day");
	...
	JOptionPane.showMessageDialog(null, "Out of Bounds! Do you here me? OUT OF BOUNDS!"
